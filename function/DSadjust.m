function DSadjust(allcol,gen_rule,TCMX,PBUB,PDEW)
...
%                     P(i)=PDEW(i);
%                 else
%                     fprintf('Pressure exceeds 2.52MPa, please consider using refrigerant. Pressure is set to 2.86MPa.\n');
%                     P(i)=28.6;
%                 end
%             end
%             if P(i)<1
...
%             fprintf('Bottom temperature exceeds the decomposition temperature 350°C or critical temperature %.0f°C.\n',TCMX(i));
...
%                 else 
%                     fprintf('Vacuum column with top temperature less than 40°C, extraction or absorption is recommended instead of distillation,\n');
