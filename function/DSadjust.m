function DSadjust(allcol,gen_rule,colpressure)
...
while 1
    ...
    if debug == column_num
        ...
        a = run();
        if a
            error('Error encountered in %dth adjustment, please check.',t)
        end
        debug = 0;
        t = t+1;
        if t > 10
