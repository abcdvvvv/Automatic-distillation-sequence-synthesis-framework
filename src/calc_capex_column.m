function cost = calc_capex_column(T_operation,P_operation,diameter,stages,L,column_material_type,plate_material_type)
global CEPCI
CEPCI = 814.6;
T_operation = T_operation*1.8 + 32; % °C --> °F
T_design = T_operation + 50; % °F
P_operation = (P_operation/1e5 - 1)*14.5038; % bar --> psia --> psig
